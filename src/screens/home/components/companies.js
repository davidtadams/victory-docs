    ...
    return (
      <div className="Companies">
        ...
        <ul className="Companies-List">
          ...
          <li className="Companies-logo" style={{maxWidth: "170px"}} dangerouslySetInnerHTML={{__html: REDFIN}} />
          ...
          <li className="Companies-logo" style={{maxWidth: "200px"}} dangerouslySetInnerHTML={{__html: ZILLOW}} />
        </ul>
